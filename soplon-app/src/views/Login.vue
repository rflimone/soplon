<template id='Login'>
  <v-ons-page>
    ...
    <div class="input">
      <p>
        <v-ons-input id="username" modifier="underbar" placeholder="Email" float v-model.trim="username"></v-ons-input>
      </p>
      <p>
        <v-ons-input id="password" modifier="underbar" type="password" placeholder="Password" float v-model.trim="password"></v-ons-input>
      </p>
      <p>
