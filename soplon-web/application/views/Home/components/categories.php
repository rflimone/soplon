  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l12 center">
        <h1 class="white-text title-large">Notificaciones de Entretención</h1>
        <br>
        <h3 class="white-text title-medium">Con Soplón, recibe tus intereses de entretención en el momento que ocurran!</h3>
        <h3 class="white-text title-medium">Directo a tu email o celular.</h3>
        <br>
        <br>
        ...
        <div class="row">
          ...
          <div class="col s12 m6 l3">
            <div class="card teal lighten-1">
              ...
              <div class="card-action center">
                <a href="<?= base_url() ?>c/cine" class="white-text">Revisar</a>
              </div>
            </div>
          </div>
          <div class="col s12 m6 l3">
